...
export function AnalyticsTasks({ title, subheader, list, ...other }: Props) {
  ...
  useEffect(() => {
    if (scrollbarRef.current) {
      ...
      // Access the actual scrollable container
      const container = (scrollbarElement as any)._container || scrollbarElement;
  ...
  return (
    <Card {...other} elevation={0}>
      ...
      <Scrollbar sx={{ minHeight: 304, maxHeight: 304 }} ref={scrollbarRef}>
